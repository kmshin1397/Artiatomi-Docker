...
m = artia.em.read('/data/kshin/T4SS_sim/PDB/c4/IMOD/Artia/motls/motl_2.em');
m(11:13, :) = 0;
mkdir(sprintf('%s/average', refineDir));
mkdir(sprintf('%s/average/motls', refineDir));
artia.em.write(m, '/data/kshin/T4SS_sim/PDB/c4/IMOD/Artia/refine/average/motls/motl_1.em');
